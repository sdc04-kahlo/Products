...
COPY products (product_id, name, slogan, description, category, default_price)
  FROM '/home/ubuntu/csv-small/product.csv'
...
COPY features
  FROM '/home/ubuntu/csv-small/features.csv'
  DELIMITER ',' CSV HEADER;
...
COPY styles
  FROM '/home/ubuntu/csv-small/styles.csv'
  DELIMITER ',' CSV HEADER;
...
COPY photos
  FROM '/home/ubuntu/csv-small/photos.csv'
  DELIMITER ',' CSV HEADER;
...
COPY skus
  FROM '/home/ubuntu/csv-small/skus.csv'
  DELIMITER ',' CSV HEADER;
...
COPY related
  FROM '/home/ubuntu/csv-small/related.csv'
  DELIMITER ',' CSV HEADER;
